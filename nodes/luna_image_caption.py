# =================================================================================
# ComfyUI-Luna-Collection: Luna Image Rate and Caption
...
- "rating": A single-word rating based on overall technical and aesthetic quality. Use the scale: S, A, B, C, F."""
        ...
        return {
            "required": {
                ...
                "luna_pipe": ("STRING", {"default": "Placeholder for LUNA_PIPE"}), 
    ...
    # --- 3. The Divine Decree ---
    RETURN_TYPES = ("IMAGE", "LUNA_META", "STRING", "STRING", "STRING")
    RETURN_NAMES = ("image", "luna_meta", "string_caption", "string_tags", "string_rating")
    FUNCTION = "caption"
    CATEGORY = "Luna Collection/Curation"

    # --- 4. The Heart of the Machine ---
    def caption(self, image: torch.Tensor, luna_pipe, master_prompt: str, get_caption: bool, get_tags: bool, get_rating: bool):
        # NOTE: The actual call to the luna_pipe will be built when we forge the Adapter node.
        # For now, we use a beautiful, terrible, magnificent fake response for testing.
        llm_response_string = """
{
  "caption": "A portrait of a confident and deviously intelligent woman, Luna, sitting at a desk in a grand library.",
...
"""
        try:
            ...
            print("Lunacollection Error: The LLM response was not valid JSON. Cannot proceed.")
            return (image, {}, "", "", "")
        ...
        return (image, luna_meta, caption_text, tags_text, rating_text)
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "luna_image_caption": "Luna Image Rate and Caption"
}